package cl.ilarrain.xposed.tabletmode.settings;
...
import cl.ilarrain.xposed.tabletmode.Common;
import cl.ilarrain.xposed.tabletmode.R;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.menu_save) {
            ...
            if (swtActive.isChecked()) {
                ...
                if (physDpi != 0) {
                    prefsEditor.putFloat(pkgName + Common.PREF_PHYSDPI, physDpi);
                } else {
